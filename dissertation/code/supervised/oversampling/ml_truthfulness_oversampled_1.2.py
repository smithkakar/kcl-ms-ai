...
# Predictor class for Imbalanced Learning using Oversampling with informative features


class TruthfulnessOversamplingPredictor:

    def __init__(self):
        print('Starting Truthfulness Predictor OVERSAMPLED Version 1.2')
    ...
    def __final__(self):
        print('Ending Truthfulness Predictor OVERSAMPLED Version 1.2')
    ...
    def get_binary_estimators(self):
        ...
        binary_estimators = {'Q01': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 6, 'n_estimators': 100}], 'Q02': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q03': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 100}], 'Q04': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 6, 'n_estimators': 100}], 'Q05': ['SVM', {'C': 1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q06': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 2, 'min_samples_split': 4, 'n_estimators': 300}], 'Q07': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}], 'Q08': ['BaggingClassifier', {'bootstrap': 'True', 'max_samples': 0.5, 'n_estimators': 300}], 'Q09': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 300}], 'Q10': ['SVM', {'C': 100, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q11': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}], 'Q12': ['XGBClassifier', {'learning_rate': 0.3, 'max_depth': 4, 'n_estimators': 100}], 'Q13': ['XGBClassifier', {'learning_rate': 0.3, 'max_depth': 4, 'n_estimators': 300}], 'Q14': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 2, 'n_estimators': 300}], 'Q15': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 6, 'n_estimators': 300}], 'Q16': ['KNeighborsClassifier', {'n_neighbors': 3, 'weights': 'distance'}], 'Q17': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 300}], 'Q18': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 300}], 'Q19': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 2, 'min_samples_split': 3, 'n_estimators': 100}], 'Q20': ['SVM', {'C': 0.1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q21': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 300}], 'Q22': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 300}], 'Q23': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 300}],
                             'Q24': ['KNeighborsClassifier', {'n_neighbors': 5, 'weights': 'uniform'}], 'Q25': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 6, 'n_estimators': 300}], 'Q26': ['XGBClassifier', {'learning_rate': 0.3, 'max_depth': 2, 'n_estimators': 300}], 'Q27': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 2, 'n_estimators': 300}], 'Q28': ['SVM', {'C': 10, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q29': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 300}], 'Q30': ['AdaBoostClassifier', {'learning_rate': 1, 'n_estimators': 300}], 'Q31': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 6, 'n_estimators': 300}], 'Q32': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 300}], 'Q33': ['SVM', {'C': 1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q34': ['SVM', {'C': 1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q35': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q36': ['SVM', {'C': 100, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q37': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 2, 'n_estimators': 100}], 'Q38': ['AdaBoostClassifier', {'learning_rate': 1, 'n_estimators': 100}], 'Q39': ['BaggingClassifier', {'bootstrap': 'True', 'max_samples': 0.5, 'n_estimators': 100}], 'Q40': ['AdaBoostClassifier', {'learning_rate': 0.3, 'n_estimators': 300}], 'Q41': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 300}], 'Q42': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}], 'Q43': ['SVM', {'C': 10, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q44': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 2, 'min_samples_split': 3, 'n_estimators': 100}], 'Q45': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 2, 'n_estimators': 100}], 'Q46': ['KNeighborsClassifier', {'n_neighbors': 5, 'weights': 'distance'}], 'Q47': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 300}], 'Q48': ['SVM', {'C': 100, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q49': ['AdaBoostClassifier', {'learning_rate': 1, 'n_estimators': 300}], 'Q50': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 4, 'n_estimators': 300}]}
    ...
    def binary_classification(self):
        ...
        for question_number in range(1, 51):
            ...
            clf_score_frame = self.naive_binary_classification(
                featured_train_data, sampled_train_y_question, question)
            ...
            best_clf_cross_val_scores, best_estimator_scores = self.run_best_estimator(featured_train_data, sampled_train_y_question,
        ...
        naive_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'naive_oversampled_clf_cross_val_scores_1.2.xlsx')
        best_binary_cross_val_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_oversampled_clf_cross_val_scores_1.2.xlsx')
        best_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_oversampled_clf_accuracy_scores_1.2.xlsx')
