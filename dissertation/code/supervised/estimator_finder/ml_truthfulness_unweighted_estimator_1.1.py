...
# Estimator class for Unweighted Learning with all features


class TruthfulnessUnweightedEstimator:

    def __init__(self):
        print('Starting Truthfulness Estimator UN-WEIGHTED Version 1.1')
    ...
    def classification(self, clf_type):
        ...
        for question_number in range(1, 51):
            ...
            best_estimator, best_estimator_params = self.find_clf_parameters(
                transformed_train_x_question, train_y_question)
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_unweighted_estimator_parameters_1.1.txt')

        with open(filename, 'w') as f:
            print(question_estimator, file=f)


unbalanced_estimator = TruthfulnessUnweightedEstimator()
