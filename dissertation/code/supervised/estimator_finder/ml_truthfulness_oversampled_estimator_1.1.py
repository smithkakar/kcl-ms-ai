...
# Estimator class for Imbalanced Learning using Over-Sampling with all features


class TruthfulnessOversampledEstimator:

    def __init__(self):
        print('Starting Truthfulness Estimator OVERSAMPLED Version 1.1')
    ...
    def find_clf_parameters(self, train_x, train_y):
        ...
        helper1.fit(train_x, train_y, cv=10, scoring='accuracy', n_jobs=-1)
    ...
    def classification(self, clf_type):
        ...
        for question_number in range(1, 51):
            ...
            best_estimator, best_estimator_params = self.find_clf_parameters(
                transformed_train_x_question, sampled_train_y_question)
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_oversampled_estimator_parameters_1.1.txt')
