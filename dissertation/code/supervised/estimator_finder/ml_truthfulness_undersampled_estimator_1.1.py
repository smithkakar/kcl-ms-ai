...
# Estimator class for Imbalanced Learning using Under-Sampling with all features


class TruthfulnessUndersampledEstimator:
    def __init__(self):
        print('Starting Truthfulness Estimator UNDERSAMPLED Version 1.1')
    ...
    def classification(self, clf_type):
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_undersampled_estimator_parameters_1.1.txt')
