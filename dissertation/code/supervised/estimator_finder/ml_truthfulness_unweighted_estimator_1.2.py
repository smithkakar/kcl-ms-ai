...
# Estimator class for Unweighted Learning with informative features


class TruthfulnessUnweightedEstimator:

    def __init__(self):
        print('Starting Truthfulness Estimator UN-WEIGHTED Version 1.2')
    ...
    def classification(self, clf_type):
        ...
        for question_number in range(1, 51):
            ...
            best_estimator, best_estimator_params = self.find_clf_parameters(
                featured_train_data, train_y_question)
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_unweighted_estimator_parameters_1.2.txt')
