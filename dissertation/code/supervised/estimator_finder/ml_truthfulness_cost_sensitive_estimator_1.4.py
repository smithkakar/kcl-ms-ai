...
class TruthfulnessCostSensitiveEstimator:
    ...
    def __init__(self):
        print('Starting Truthfulness Estimator COST-SENSITIVE Version 1.4')
        ...
        # Scoring metric for binary is same as in 1.3 version
        # self.classification('binary')
        # print(sorted(metrics.SCORERS.keys()))
        # Scoring metric is F1 micro instead of balanced_accuracy in version 1.3
    ...
    def classification(self, clf_type):
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_cost_sensitive_estimator_parameters_1.4.txt')
