...
# Estimator class for Imbalanced Learning using Under-Sampling with informative features


class TruthfulnessUndersampledEstimator:

    def __init__(self):
        print('Starting Truthfulness Estimator UNDERSAMPLED Version 1.2')
    ...
    def find_clf_parameters(self, train_x, train_y, clf_type):
        ...
        params1 = {
            ...
            'EasyEnsembleClassifier': [{'n_estimators': n_estimators, 'sampling_strategy': sampling_strategy}],
        }
    ...
    def classification(self, clf_type):
        ...
        filename = os.path.join(
            RESULTS_DIR, clf_type + '_undersampled_estimator_parameters_1.2.txt')

        with open(filename, 'w') as f:
            print(question_estimator, file=f)


balanced_estimator = TruthfulnessUndersampledEstimator()
