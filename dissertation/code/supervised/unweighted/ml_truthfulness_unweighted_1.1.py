...
# Predictor class for Unweighted Learning with all features


class TruthfulnessUnweighedPredictor:

    def __init__(self):
        print('Starting Truthfulness Predictor UN-WEIGHTED Version 1.1')
    ...
    def __final__(self):
        print('Ending Truthfulness Predictor UN-WEIGHTED Version 1.1')
    ...
    def create_score_frame(self, scores):
        ...
        clf_score_frame = pd.DataFrame({
            'Question': [dtc_scores['Question'], lrc_scores['Question'], knn_scores['Question'], rfc_scores['Question'],
                         etc_scores['Question'],
                         svm_scores['Question'], nbc_scores['Question'], bag_scores['Question'], ada_scores['Question'],
                         xgb_scores['Question']],
    ...
    def get_binary_estimators(self):
        binary_estimators = {'Q01': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 4}], 'Q02': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}], 'Q03': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 100}], 'Q04': ['AdaBoostClassifier', {'learning_rate': 1, 'n_estimators': 300}], 'Q05': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 100}], 'Q06': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 100}], 'Q07': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 2, 'n_estimators': 300}], 'Q08': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 2}], 'Q09': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 3, 'n_estimators': 300}], 'Q10': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 100}], 'Q11': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q12': ['XGBClassifier', {'learning_rate': 0.3, 'max_depth': 4, 'n_estimators': 300}], 'Q13': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3}], 'Q14': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3}], 'Q15': ['BaggingClassifier', {'bootstrap': 'False', 'max_samples': 1.0, 'n_estimators': 100}], 'Q16': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q17': ['BaggingClassifier', {'bootstrap': 'True', 'max_samples': 0.2, 'n_estimators': 100}], 'Q18': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 300}], 'Q19': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 2, 'min_samples_split': 4, 'n_estimators': 100}], 'Q20': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 100}], 'Q21': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q22': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 100}], 'Q23': ['RandomForestClassifier', {
            'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 100}], 'Q24': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 300}], 'Q25': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q26': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q27': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q28': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q29': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 3, 'n_estimators': 100}], 'Q30': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q31': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q32': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 4, 'n_estimators': 300}], 'Q33': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q34': ['SVM', {'C': 1, 'gamma': 'auto', 'kernel': 'linear'}], 'Q35': ['LogisticRegression', {'C': 0.01, 'penalty': 'l1', 'solver': 'liblinear'}], 'Q36': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 100}], 'Q37': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q38': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q39': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q40': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q41': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 100}], 'Q42': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q43': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q44': ['ExtraTreesClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 3, 'n_estimators': 300}], 'Q45': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}], 'Q46': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q47': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q48': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q49': ['BaggingClassifier', {'bootstrap': 'True', 'max_samples': 0.2, 'n_estimators': 300}], 'Q50': ['XGBClassifier', {'learning_rate': 1, 'max_depth': 2, 'n_estimators': 100}]}
    ...
    def binary_classification(self):
        ...
        for question_number in range(1, 51):
            ...
            clf_score_frame = self.naive_binary_classification(
                transformed_train_x_question, train_y_question, question)
        ...
        naive_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'naive_unweighted_clf_cross_val_scores_1.1.xlsx')
        best_binary_cross_val_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_unweighted_clf_cross_val_scores_1.1.xlsx')
        best_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_unweighted_clf_accuracy_scores_1.1.xlsx')
...
predictor = TruthfulnessUnweighedPredictor()
