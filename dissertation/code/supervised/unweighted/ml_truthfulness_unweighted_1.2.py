...
# Predictor class for Unweighted Learning with informative features


class TruthfulnessUnweightedPredictor:

    def __init__(self):
        print('Starting Truthfulness Predictor UN-WEIGHTED Version 1.2')
    ...
    def __final__(self):
        print('Ending Truthfulness Predictor UN-WEIGHTED Version 1.2')
    ...
    def get_binary_estimators(self):
        # cv=10 with balanced_accuracy
        binary_estimators = {'Q01': ['AdaBoostClassifier', {'learning_rate': 0.1, 'n_estimators': 300}], 'Q02': ['SVM', {'C': 0.01, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q03': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 300}], 'Q04': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 4, 'n_estimators': 300}], 'Q05': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 100}], 'Q06': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 100}], 'Q07': ['XGBClassifier', {'learning_rate': 0.1, 'max_depth': 2, 'n_estimators': 300}], 'Q08': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q09': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 100}], 'Q10': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 300}], 'Q11': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q12': ['KNeighborsClassifier', {'n_neighbors': 3, 'weights': 'uniform'}], 'Q13': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q14': ['SVM', {'C': 100, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q15': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q16': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 100}], 'Q17': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 2, 'min_samples_split': 3, 'n_estimators': 300}], 'Q18': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 6, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 100}], 'Q19': ['XGBClassifier', {'learning_rate': 0.3, 'max_depth': 2, 'n_estimators': 300}], 'Q20': ['SVM', {'C': 0.01, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q21': ['SVM', {'C': 0.5, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q22': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 300}], 'Q23': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 100}],
                             'Q24': ['SVM', {'C': 1, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q25': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q26': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q27': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q28': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4}], 'Q29': ['RandomForestClassifier', {'criterion': 'gini', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 100}], 'Q30': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q31': ['SVM', {'C': 0.1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q32': ['SVM', {'C': 0.5, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q33': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q34': ['SVM', {'C': 0.1, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q35': ['LogisticRegression', {'C': 0.01, 'penalty': 'l1', 'solver': 'liblinear'}], 'Q36': ['DecisionTreeClassifier', {'max_depth': 4, 'min_samples_leaf': 1, 'min_samples_split': 3}], 'Q37': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q38': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 300}], 'Q39': ['BaggingClassifier', {'bootstrap': 'True', 'max_samples': 1.0, 'n_estimators': 300}], 'Q40': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q41': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 4, 'n_estimators': 300}], 'Q42': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 1, 'min_samples_split': 2}], 'Q43': ['SVM', {'C': 0.1, 'gamma': 'auto', 'kernel': 'rbf'}], 'Q44': ['SVM', {'C': 0.01, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q45': ['SVM', {'C': 0.1, 'gamma': 'scale', 'kernel': 'rbf'}], 'Q46': ['GaussianNB', {'var_smoothing': 1e-09}], 'Q47': ['ExtraTreesClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 300}], 'Q48': ['DecisionTreeClassifier', {'max_depth': 2, 'min_samples_leaf': 3, 'min_samples_split': 2}], 'Q49': ['RandomForestClassifier', {'criterion': 'entropy', 'max_depth': 4, 'min_samples_leaf': 3, 'min_samples_split': 2, 'n_estimators': 300}], 'Q50': ['AdaBoostClassifier', {'learning_rate': 1, 'n_estimators': 300}]}
    ...
    def binary_classification(self):
        ...
        for question_number in range(1, 51):
            ...
            clf_score_frame = self.naive_binary_classification(
                featured_train_data, train_y_question, question)
        ...
        naive_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'naive_unweighted_clf_cross_val_scores_1.2.xlsx')
        best_binary_cross_val_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_unweighted_clf_cross_val_scores_1.2.xlsx')
        best_binary_clf_file_path = os.path.join(
            BINARY_RESULTS_DIR, 'best_unweighted_clf_accuracy_scores_1.2.xlsx')
...
predictor = TruthfulnessUnweightedPredictor()
